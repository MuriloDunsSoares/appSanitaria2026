...
///
/// Responsabilidades:
/// - Formulário completo para cadastro de profissional
...
/// - Dados profissionais: especialidade, formação, certificados, experiência
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: AppConstants.professionalSpecialties.map((specialty) {
                  ...
                  validator: (value) =>
                      value == null ? 'Selecione a especialidade' : null,
                ),
                const SizedBox(height: 16),
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Ex: Técnico em Enfermagem',
                  ),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Formação é obrigatória';
                    }
                    return null;
                  },
                ),
                ...
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'Ex: COREN ativo',
                  ),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                      return 'Certificados são obrigatórios';
                    }
                    return null;
                  },
                ),
