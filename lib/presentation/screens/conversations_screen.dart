  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () {
                          ref.read(chatProviderV2.notifier).loadConversations();
                        },
                  ...
                  : RefreshIndicator(
                      ...
                      child: ListView.builder(
                        padding: EdgeInsets.only(
                          top: 8,
                          bottom: isPatient ? 80 : 16, // Padding maior para pacientes por causa do bottom nav
                        ),
      ...
      // Bottom Navigation apenas para pacientes
        bottomNavigationBar: isPatient ? const PatientBottomNav(currentIndex: 1) : null,
      ),
    );
  }
}
